...
import { PickerValue, PickerValueExtend, PickerViewPropsType } from '../picker-view/PropsType';
...
export interface PickerPropsType extends PickerViewPropsType, WithThemeStyles<PickerViewStyle & PickerStyle>, Omit<PopupPickerProps, 'onOk' | 'styles'> {
