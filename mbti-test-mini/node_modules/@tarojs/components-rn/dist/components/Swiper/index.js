...
class _Swiper extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Carousel, { style: StyleSheet.flatten(style), dots: Boolean(indicatorDots), dotStyle: { backgroundColor: indicatorColor }, dotActiveStyle: { backgroundColor: indicatorActiveColor }, autoplay: Boolean(autoplay), selectedIndex: current, autoplayInterval: interval, infinite: Boolean(circular), vertical: Boolean(vertical), afterChange: this.onIndexChanged }, children));
    }
}
